...
void main() {
  ...
  group('AddToWatchlist TvSeries', () {
    blocTest<TvSeriesDetailBloc, TvSeriesDetailState>(
      ...
      act: (bloc) => bloc.add(const AddTvSeriesWatchlist(tTvSeriesDetail)),
      expect: () => [
  ...
  group('RemoveFromWatchlist TvSeries', () {
    blocTest<TvSeriesDetailBloc, TvSeriesDetailState>(
      ...
      act: (bloc) => bloc.add(const RemoveTvSeriesWatchlist(tTvSeriesDetail)),
      expect: () => [
        tvSeriesDetailStateInit.copyWith(message: 'Failed'),
      ],
      verify: (_) {
  ...
  group('LoadWatchlistStatus', () {
    blocTest<TvSeriesDetailBloc, TvSeriesDetailState>(
      ...
      act: (bloc) => bloc.add(const StatusTvSeriesWatchlist(tId)),
      expect: () => [
